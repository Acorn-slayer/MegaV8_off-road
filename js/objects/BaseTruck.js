...
class BaseTruck extends Phaser.GameObjects.Container {
    ...
    createTruckGraphics(scene, color) {
        ...
        if (this.vehicleType === 'bike') {
            // Wheels (drawn first so the bike body sits on top)
            gfx.fillStyle(0x111111, 1);
            gfx.fillRect(-2, -16, 4, 8);
            gfx.fillRect(-2, 8, 4, 8);
            gfx.fillStyle(0x777777, 1);
            gfx.fillRect(-1, -14, 2, 4);
            gfx.fillRect(-1, 10, 2, 4);

            // Top-down motorcycle body
            gfx.fillStyle(0x000000, 1);
            gfx.fillRoundedRect(-4, -10, 8, 20, 4);
            gfx.fillRoundedRect(-6, -8, 12, 16, 5);

            // Fairing and tank highlight
            gfx.fillStyle(0x111111, 1);
            gfx.fillRoundedRect(-5, -12, 10, 6, 3);
            gfx.fillStyle(0x333333, 1);
            gfx.fillRoundedRect(-3, -3, 6, 8, 3);
            gfx.fillStyle(0x222222, 1);
            gfx.fillRoundedRect(-3, -13, 6, 4, 2);

            // Handlebars
            gfx.fillStyle(0x333333, 1);
            gfx.fillRect(-7, -12, 3, 1);
            gfx.fillRect(4, -12, 3, 1);
            gfx.fillRect(-6, -12, 1, 4);
            gfx.fillRect(5, -12, 1, 4);
