...
const TrackBuilder = {
    ...
    build(def) {
        ...
        const baseTrackWidth = def.trackWidth || 70;
        return {
            ...
            wallWidth: Math.max(2, Math.round(baseTrackWidth * 0.06)),
    ...
    centerTrack(track, worldW, worldH, padX, padY) {
        ...
        // Keep wall width proportional to the final track width
        track.wallWidth = Math.max(2, Math.round(track.trackWidth * 0.06));
