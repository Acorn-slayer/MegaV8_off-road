...
class ShopScene extends Phaser.Scene {
    ...
    create() {
        ...
        const vehicleShopBtn = this.add.text(1140, 105, 'VEHICLE SHOP', {
            fontSize: '10px', fontFamily: "'Press Start 2P', cursive",
            color: '#ffffff', backgroundColor: '#334455', padding: { x: 8, y: 4 }
        }).setOrigin(0, 0.5).setInteractive({ useHandCursor: true });
        vehicleShopBtn.on('pointerover', () => vehicleShopBtn.setStyle({ backgroundColor: '#556677' }));
        vehicleShopBtn.on('pointerout', () => vehicleShopBtn.setStyle({ backgroundColor: '#334455' }));
