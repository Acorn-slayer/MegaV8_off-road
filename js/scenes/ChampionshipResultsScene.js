...
class ChampionshipResultsScene extends Phaser.Scene {
    ...
    create() {
        this.add.graphics().fillStyle(0x0a0a1a, 1).fillRect(0, 0, 800, 600);
        ...
        this.add.text(400, 50, 'CHAMPIONSHIP', {
            fontSize: '28px',
        ...
        this.add.text(400, 100, 'FINAL STANDINGS', {
            fontSize: '16px',
            fontFamily: "'Press Start 2P', cursive",
            color: '#ffffff'
        }).setOrigin(0.5);
        ...
        if (isWinner) {
            ...
            this.add.text(400, 190, `+$${bonus} Championship Bonus!`, {
                ...style, fontSize: '16px', color: '#00ff88'
            }).setOrigin(0.5);
        } else {
            const labels = ['1st', '2nd', '3rd', '4th'];
            this.add.text(400, 155, `You finished ${labels[playerPos]} overall`, {
